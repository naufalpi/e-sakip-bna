...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Inbox Workflow', href: '/workflow/inbox' },
];
                        ...
                        <tbody>
                            <tr v-for="row in items.data" :key="row.id" class="border-b last:border-0">
                                ...
                                <td class="min-w-72 px-4 py-3">
                                    ...
                                    <div class="mt-1 text-xs text-muted-foreground">{{ row.context.subtitle || row.note || 'Tidak ada catatan tambahan.' }}</div>
                                </td>
                                <td class="px-4 py-3">
                                ...
                                <td class="px-4 py-3">
                                    ...
                                    <div v-if="row.context.status_data && row.context.status_data !== row.status" class="mt-1 text-xs text-muted-foreground">
