    ...
    <form class="flex max-w-3xl flex-col gap-4 p-4" @submit.prevent="submit">
        <div>
            <h1 class="text-2xl font-semibold tracking-normal">
                {{ mode === 'create' ? 'Tambah Urusan Pemerintahan' : 'Edit Urusan Pemerintahan' }}
            </h1>
            <p class="mt-1 text-sm text-muted-foreground">
                Kode urusan harus mengikuti referensi resmi agar mudah disinkronkan dengan data perencanaan.
            </p>
        </div>
