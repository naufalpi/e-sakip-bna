...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Master OPD', href: '/master/opd' },
];
                            ...
                            <tr v-for="opd in opds.data" :key="opd.id" class="border-b last:border-0">
                                ...
                                <td class="px-4 py-3 text-right">
                                    <div v-if="can.create" class="inline-flex gap-2">
                                        <Link :href="route('master.opd.edit', opd.id)" class="rounded-md border px-2 py-1 text-xs hover:bg-muted">Edit</Link>
                                        <button type="button" class="rounded-md border px-2 py-1 text-xs text-red-700 hover:bg-red-50" @click="destroy(opd)">
                                            Hapus
                                        </button>
                                    </div>
