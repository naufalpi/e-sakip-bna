...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <form class="flex flex-col gap-5 p-4 pb-24" @submit.prevent="submit">
                ...
                <div class="border-b bg-[linear-gradient(135deg,#f8fafc,#ecfdf5)] px-4 py-5 sm:px-6">
                    <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                        <div class="min-w-0">
                            ...
                            <div class="mt-4 inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-white px-3 py-1 text-xs font-semibold uppercase text-emerald-800">
                                <ClipboardList class="size-3.5" />
                                Identitas Renstra OPD
                            </div>
                            <h1 class="mt-3 text-2xl font-semibold tracking-normal text-slate-950">{{ pageTitle }}</h1>
                            <p class="mt-2 max-w-3xl text-sm leading-6 text-muted-foreground">
                                Isi data dasar Renstra terlebih dahulu. Setelah disimpan, lanjutkan pengisian cascading tujuan, sasaran,
                                program, kegiatan, indikator, dan target pada halaman detail.
                            </p>
                        </div>
                        ...
                        <div class="rounded-lg border bg-white p-4 text-sm shadow-sm lg:w-80">
                            ...
                            <p class="mt-2 text-xs leading-5 text-muted-foreground">
                                Untuk input awal, status biasanya tetap Draft. Pengajuan dan verifikasi dilakukan melalui workflow setelah data
                                cascading lengkap.
                            </p>
                        </div>
                    </div>
                ...
                <div class="grid gap-5">
                    <section class="rounded-lg border bg-card p-4 shadow-sm sm:p-5">
                        <div class="flex gap-3">
                            <span class="flex size-9 shrink-0 items-center justify-center rounded-md bg-emerald-100 text-sm font-semibold text-emerald-800">
                                1
                            </span>
                            <div class="min-w-0">
                        ...
                        <div class="mt-5 grid gap-4 lg:grid-cols-2">
                            <label class="grid min-w-0 gap-2" for="opd_id">
                                ...
                                <span class="text-xs leading-5 text-muted-foreground">
                                    Admin OPD otomatis menggunakan OPD sesuai akun.
                                </span>
                ...
                <aside class="grid gap-4 xl:sticky xl:top-20 xl:self-start">
                    ...
                    <section class="rounded-lg border bg-card p-4 shadow-sm">
                        ...
                        <ol class="mt-4 space-y-3 text-sm leading-6 text-slate-700">
                            <li class="flex gap-3">
                                <span class="flex size-6 shrink-0 items-center justify-center rounded-full bg-slate-100 text-xs font-semibold text-slate-700">1</span>
                                <span>Buka detail Renstra.</span>
                            </li>
                            <li class="flex gap-3">
                                <span class="flex size-6 shrink-0 items-center justify-center rounded-full bg-slate-100 text-xs font-semibold text-slate-700">2</span>
                                <span>Isi tujuan, sasaran, program, kegiatan, dan sub kegiatan.</span>
                            </li>
                            <li class="flex gap-3">
                                <span class="flex size-6 shrink-0 items-center justify-center rounded-full bg-slate-100 text-xs font-semibold text-slate-700">3</span>
            ...
            <div class="fixed inset-x-0 bottom-0 z-30 border-t bg-background/95 px-4 py-3 shadow-[0_-8px_24px_rgba(15,23,42,0.08)] backdrop-blur supports-[backdrop-filter]:bg-background/85 lg:left-[var(--sidebar-width,0px)]">
