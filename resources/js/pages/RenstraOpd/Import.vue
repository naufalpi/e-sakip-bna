    ...
    <div class="flex max-w-5xl flex-col gap-4 p-4">
        <div>
            ...
            <p class="mt-1 text-sm text-muted-foreground">
                Upload file `.xlsx`, `.csv`, atau `.txt` untuk preview dan validasi. Data Renstra diterapkan secara all-or-nothing agar tidak masuk
                sebagian.
            </p>
        </div>
        ...
        <form class="rounded-lg border bg-card p-4" @submit.prevent="submit">
            <div class="flex items-start gap-3">
                ...
                <div class="grid flex-1 gap-4">
                    ...
                    <div>
                        <a
                            :href="route('renstra-opd.import.template')"
