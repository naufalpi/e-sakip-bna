...
<template>
    ...
    <div class="flex flex-col gap-4 p-4">
        <div class="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
            ...
            <Link
                v-if="can.manage"
                :href="route('rencana-aksi.create')"
                ...
                <table class="w-full text-left text-sm">
                    ...
                    <tbody>
                        <tr v-for="row in items.data" :key="row.id" class="border-b last:border-0">
                            ...
                            <td class="px-4 py-3">
                                <span class="rounded-full bg-slate-100 px-2 py-1 text-xs text-slate-700">{{ row.items_count }} aksi</span>
                            </td>
                            <td class="px-4 py-3">
                            ...
                            <td class="px-4 py-3 text-right">
                                <div class="inline-flex gap-2">
                                    <Link :href="route('rencana-aksi.show', row.id)" class="rounded-md border px-2 py-1 text-xs hover:bg-muted"
                                        >Buka</Link
                                    >
                                    <Link
                                        v-if="can.manage"
                                        :href="route('rencana-aksi.edit', row.id)"
