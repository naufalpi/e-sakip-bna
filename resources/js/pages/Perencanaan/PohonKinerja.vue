        ...
        <form class="grid gap-3 rounded-lg border bg-card p-4 lg:grid-cols-[220px_1fr_1fr_auto]" @submit.prevent="submit">
            ...
            <div class="grid gap-2">
                ...
                <select
                    ...
                    :disabled="!selectedModeNeedsRpjmd"
                >
            ...
            <div class="grid gap-2">
                ...
                <select
                    ...
                    class="h-9 rounded-md border bg-background px-3 text-sm"
                    :disabled="!selectedModeNeedsRenstra"
                >
            ...
            <div class="flex items-end">
                <button type="submit" class="h-9 rounded-md bg-emerald-700 px-4 text-sm font-medium text-white hover:bg-emerald-800">
                    Tampilkan
                </button>
            </div>
        </form>
