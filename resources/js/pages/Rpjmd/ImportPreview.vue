...
<template>
    <Head title="Preview Import RPJMD" />
    <div class="flex flex-col gap-4 p-4">
        <div class="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
            <div>
                <div class="flex flex-wrap items-center gap-2">
                    <h1 class="text-2xl font-semibold tracking-normal">Preview Import RPJMD</h1>
        ...
        <section v-if="batch.metadata?.applied" class="grid gap-3 rounded-lg border bg-card p-4 md:grid-cols-4">
            ...
            <div>
                ...
                <Link
                    v-if="batch.metadata.applied.rpjmd_id"
                    :href="route('rpjmd.show', batch.metadata.applied.rpjmd_id)"
            ...
            <div class="flex items-center gap-2 border-b p-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-muted-foreground">
                        Baris disimpan ke import_batch_rows. Status tiap baris diperbarui setelah import diterapkan.
                    </p>
                </div>
            </div>
