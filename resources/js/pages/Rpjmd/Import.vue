                ...
                <div class="flex items-start gap-3">
                    ...
                    <div class="grid flex-1 gap-4">
                        ...
                        <div class="flex justify-end gap-2">
                            ...
                            <button type="submit" :disabled="form.processing" class="inline-flex items-center gap-2 rounded-md bg-emerald-700 px-4 py-2 text-sm font-medium text-white hover:bg-emerald-800 disabled:opacity-60">
                                <Upload class="size-4" />
                                Upload dan Preview
                            </button>
                        </div>
