                ...
                <section v-if="isCreate" class="rounded-lg border bg-card p-4 shadow-sm">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-muted-foreground">Format umum seperti PDF, gambar, Word, dan spreadsheet dapat diunggah.</p>
                        </div>
                    </div>
                ...
                <section class="rounded-lg border bg-card p-4 shadow-sm">
                    ...
                    <div class="mt-5 rounded-lg bg-emerald-50 p-3 text-sm text-emerald-900">
                        ...
                        <p class="mt-1 text-xs leading-5">
                            Untuk tampil di halaman publik, pilih jenis dokumen yang sesuai, isi OPD dan periode, lalu gunakan status terverifikasi,
                            disetujui, atau terkunci.
                        </p>
                    </div>
                </section>
            </aside>
