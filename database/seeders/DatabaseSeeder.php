...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $uiPermissions = [
            ...
            ['name' => 'rka.view', 'label' => 'Lihat RKA OPD', 'module' => 'rka'],
            ['name' => 'rka.manage', 'label' => 'Kelola RKA OPD', 'module' => 'rka'],
            ['name' => 'rka.verify', 'label' => 'Verifikasi RKA OPD', 'module' => 'rka'],
            ['name' => 'dpa.view', 'label' => 'Lihat DPA OPD', 'module' => 'dpa'],
            ['name' => 'dpa.manage', 'label' => 'Kelola DPA OPD', 'module' => 'dpa'],
            ...
            ['name' => 'referensi_jabatan.view', 'label' => 'Lihat Referensi Jabatan Global', 'module' => 'jabatan_organisasi'],
            ['name' => 'referensi_jabatan.manage', 'label' => 'Kelola Referensi Jabatan Global', 'module' => 'jabatan_organisasi'],
        ...
        $roles = [
            ...
            'admin_kabupaten_bagian_organisasi' => [
                ...
                'permissions' => ['dashboard.view', 'view_dashboard_kabupaten', 'opd.view', 'opd_units.manage', 'jabatan_organisasi.view', 'jabatan_organisasi.manage', 'jabatan_organisasi.manage_opd', 'jabatan_organisasi.verify', 'referensi_jabatan.view', 'referensi_jabatan.manage', 'pejabat_jabatan.manage', 'pegawai.view', 'pegawai.manage', 'users.view', 'periode.view', 'satuan.view', 'strategi.view', 'urusan.view', 'rpjmd.view', 'view_rpjmd', 'renstra.view', 'view_renstra_opd', 'rkpd.view', 'renja.view', 'rka.view', 'dpa.view', 'kinerja.view', 'evaluasi.view', 'dokumen.view', 'lkjip.view', 'laporan.view', 'export_laporan'],
            ],
            'admin_kabupaten_bapperida' => [
                'label' => 'Admin Kabupaten Bapperida',
                'description' => 'Input dan kelola data perencanaan kabupaten/RPJMD.',
                'permissions' => ['dashboard.view', 'view_dashboard_kabupaten', 'opd.view', 'jabatan_organisasi.view', 'referensi_jabatan.view', 'pegawai.view', 'periode.view', 'periode.manage', 'satuan.view', 'satuan.manage', 'strategi.view', 'strategi.manage', 'urusan.view', 'urusan.manage', 'manage_master_umum', 'rpjmd.view', 'rpjmd.manage', 'view_rpjmd', 'manage_rpjmd', 'renstra.view', 'view_renstra_opd', 'rkpd.view', 'rkpd.manage', 'renja.view', 'rka.view', 'rka.manage', 'rka.verify', 'dpa.view', 'kinerja.view', 'dokumen.view', 'dokumen.manage', 'manage_dokumen', 'lkjip.view', 'laporan.view', 'export_laporan'],
            ],
            'admin_kabupaten_bpkad' => [
                ...
                'permissions' => ['dashboard.view', 'view_dashboard_kabupaten', 'opd.view', 'jabatan_organisasi.view', 'pegawai.view', 'periode.view', 'rka.view', 'dpa.view', 'dpa.verify', 'dokumen.view', 'laporan.view', 'export_laporan'],
            ],
            'admin_kabupaten_inspektorat' => [
                'label' => 'Admin Kabupaten Inspektorat',
                'description' => 'Evaluasi kinerja, LKE, LHE, rekomendasi, dan verifikasi tindak lanjut.',
                'permissions' => ['dashboard.view', 'view_dashboard_kabupaten', 'opd.view', 'jabatan_organisasi.view', 'pegawai.view', 'periode.view', 'strategi.view', 'rpjmd.view', 'view_rpjmd', 'renstra.view', 'view_renstra_opd', 'rkpd.view', 'renja.view', 'rka.view', 'dpa.view', 'kinerja.view', 'evaluasi.view', 'evaluasi.manage', 'manage_evaluasi', 'verify_realisasi', 'dokumen.view', 'dokumen.manage', 'manage_dokumen', 'lkjip.view', 'laporan.view', 'export_laporan'],
            ],
