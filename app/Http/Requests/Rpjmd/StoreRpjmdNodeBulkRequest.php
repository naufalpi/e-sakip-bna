...
class StoreRpjmdNodeBulkRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'cakupan_pengampu' => ['nullable', Rule::in(['opd_tertentu', 'semua_opd'])],
            ...
            'rows.*.existing_pagu_id' => ['nullable', 'integer'],
            'rows.*.satuan_indikator_id' => ['nullable', 'integer', 'exists:satuan_indikator,id'],
            'rows.*.opd_id' => ['nullable', 'integer', 'exists:opds,id'],
            'rows.*.opd_ids' => ['nullable', 'array'],
            'rows.*.opd_ids.*' => ['integer', 'exists:opds,id'],
            'rows.*.cakupan_pengampu' => ['nullable', Rule::in(['opd_tertentu', 'semua_opd'])],
            ...
            'rows.*.pagu_anggaran' => ['nullable', 'string', 'max:255'],
