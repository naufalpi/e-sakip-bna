...
class StoreOpdUnitRequest extends FormRequest
{
    public function authorize(): bool
    {
        if ($this->user()->hasRole('admin_opd') && filled($this->user()->opd_unit_id)) {
            return false;
        }
    ...
    public function rules(): array
    {
        return [
            ...
            'kode' => ['required', 'string', 'max:120', Rule::unique('opd_units', 'kode')->where('opd_id', $this->input('opd_id'))],
