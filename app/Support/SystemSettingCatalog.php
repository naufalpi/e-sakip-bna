    ...
    public static function groups(): array
    {
        return [
            ...
            'workflow' => [
                ...
                'description' => 'Aturan pengajuan, pemeriksaan, perbaikan, persetujuan, dan penguncian data.',
            ],
            'dashboard' => [
                'label' => 'Dashboard',
    ...
    public static function settings(): array
    {
        ...
        return [
            ...
            'sakip.lock_target_approved' => [
                'group' => 'siklus_sakip',
                'label' => 'Kunci Target Disetujui',
                'type' => 'boolean',
                'value' => true,
                'is_public' => false,
                'description' => 'Jika aktif, target yang sudah disetujui tidak dapat diedit tanpa proses perbaikan resmi.',
                'placeholder' => '1',
            ],
            'sakip.require_approved_target_before_realisasi' => [
                'group' => 'siklus_sakip',
                'label' => 'Realisasi Harus dari Target Disetujui',
                'type' => 'boolean',
                'value' => true,
                'is_public' => false,
            ...
            'workflow.auto_assign_reviewer' => [
                'group' => 'workflow',
                'label' => 'Pilih Pemeriksa Otomatis',
                'type' => 'boolean',
                'value' => false,
                'is_public' => false,
                'description' => 'Jika aktif, sistem mencoba memilih pemeriksa otomatis saat data diajukan.',
                'placeholder' => '0',
            ],
            'workflow.default_revision_days' => [
                'group' => 'workflow',
                'label' => 'Batas Waktu Perbaikan (Hari)',
                'type' => 'integer',
                'value' => 7,
                'is_public' => false,
                'description' => 'Jumlah hari rekomendasi penyelesaian setelah pemeriksa meminta perbaikan.',
                'placeholder' => '7',
            ],
            'workflow.allow_super_admin_unlock' => [
                'group' => 'workflow',
                'label' => 'Super Admin Bisa Membuka Kunci Data',
                'type' => 'boolean',
                'value' => true,
                'is_public' => false,
            ...
            'workflow.notify_reviewer_on_submit' => [
                'group' => 'workflow',
                'label' => 'Notifikasi Pemeriksa Saat Pengajuan',
                'type' => 'boolean',
                'value' => true,
                'is_public' => false,
                'description' => 'Membuat notifikasi untuk pemeriksa saat OPD mengajukan data.',
                'placeholder' => '1',
            ],
