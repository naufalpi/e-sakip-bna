...
use App\Http\Controllers\Perencanaan\RkpdItemImportController;
...
Route::middleware(['auth', 'active', 'verified'])->group(function () {
    ...
    Route::get('rkpd/{rkpd}/items/import', [RkpdItemImportController::class, 'create'])->name('rkpd.items.import.create');
    Route::get('rkpd/{rkpd}/items/import/template', [RkpdItemImportController::class, 'template'])->name('rkpd.items.import.template');
    Route::post('rkpd/{rkpd}/items/import', [RkpdItemImportController::class, 'store'])->name('rkpd.items.import.store');
    Route::get('rkpd/{rkpd}/items/import/{importBatch}', [RkpdItemImportController::class, 'show'])->name('rkpd.items.import.show');
    Route::post('rkpd/{rkpd}/items/import/{importBatch}/apply', [RkpdItemImportController::class, 'apply'])->name('rkpd.items.import.apply');
